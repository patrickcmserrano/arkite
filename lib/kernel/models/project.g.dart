...
const ProjectSchema = CollectionSchema(
  ...
  properties: {
    ...
    r'globalSystemInstruction': PropertySchema(
      id: 1,
      name: r'globalSystemInstruction',
...
int _projectEstimateSize(
  ...
  {
    final value = object.globalSystemInstruction;
    if (value != null) {
...
void _projectSerialize(
  ...
  writer.writeString(offsets[1], object.globalSystemInstruction);
...
Project _projectDeserialize(
  ...
  object.globalSystemInstruction = reader.readStringOrNull(offsets[1]);
  object.id = id;
...
extension ProjectQueryFilter
  ...
  QueryBuilder<Project, Project, QAfterFilterCondition>
      globalSystemInstructionIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNull(
        property: r'globalSystemInstruction',
      ));
    });
  }

  QueryBuilder<Project, Project, QAfterFilterCondition>
      globalSystemInstructionIsNotNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Project, Project, QAfterFilterCondition>
      globalSystemInstructionEqualTo(
    String? value, {
  ...
  QueryBuilder<Project, Project, QAfterFilterCondition>
      globalSystemInstructionGreaterThan(
    String? value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Project, Project, QAfterFilterCondition>
      globalSystemInstructionLessThan(
    String? value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Project, Project, QAfterFilterCondition>
      globalSystemInstructionBetween(
    String? lower,
    String? upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Project, Project, QAfterFilterCondition>
      globalSystemInstructionStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Project, Project, QAfterFilterCondition>
      globalSystemInstructionEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Project, Project, QAfterFilterCondition>
      globalSystemInstructionContains(String value,
          {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Project, Project, QAfterFilterCondition>
      globalSystemInstructionMatches(String pattern,
          {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Project, Project, QAfterFilterCondition>
      globalSystemInstructionIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'globalSystemInstruction',
        value: '',
  ...
  QueryBuilder<Project, Project, QAfterFilterCondition>
      globalSystemInstructionIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.greaterThan(
        property: r'globalSystemInstruction',
        value: '',
...
extension ProjectQuerySortBy on QueryBuilder<Project, Project, QSortBy> {
  ...
  QueryBuilder<Project, Project, QAfterSortBy> sortByGlobalSystemInstruction() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'globalSystemInstruction', Sort.asc);
    });
  }

  QueryBuilder<Project, Project, QAfterSortBy>
      sortByGlobalSystemInstructionDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'globalSystemInstruction', Sort.desc);
    });
  }
...
extension ProjectQuerySortThenBy
  ...
  QueryBuilder<Project, Project, QAfterSortBy> thenByGlobalSystemInstruction() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'globalSystemInstruction', Sort.asc);
    });
  }
  ...
  QueryBuilder<Project, Project, QAfterSortBy>
      thenByGlobalSystemInstructionDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'globalSystemInstruction', Sort.desc);
    });
  }
...
extension ProjectQueryWhereDistinct
  ...
  QueryBuilder<Project, Project, QDistinct> distinctByGlobalSystemInstruction(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'globalSystemInstruction',
          caseSensitive: caseSensitive);
    });
  }
...
extension ProjectQueryProperty
  ...
  QueryBuilder<Project, String?, QQueryOperations>
      globalSystemInstructionProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'globalSystemInstruction');
    });
  }
